...
=======
    ...
    { -- Catppuccin colorscheme
        ...
        priority = 1000, -- Make sure to load this before all the other start plugins
        config = function()
            -- Protected require to catch potential errors
            local status, catppuccin = pcall(require, 'catppuccin')
            if not status then
                vim.notify('Failed to load Catppuccin: ' .. catppuccin, vim.log.levels.ERROR)
                return
            end

            -- Protected setup to catch configuration errors
            ...
            if not setup_status then
                vim.notify('Failed to setup Catppuccin: ' .. setup_error, vim.log.levels.ERROR)
                return
            end
